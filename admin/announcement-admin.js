            ...
            <div>
                ...
                ${
                    announcement.audience === "member"
                        ? '<span class="announcement-status unpublished">' +
                          '自治会員のみ</span>'
                        : ""
                }

                ${
                    announcement.audience === "guest"
                        ? '<span class="announcement-status unpublished">' +
                          '自治会員以外のみ</span>'
                        : ""
                }
    ...
    modal.innerHTML = `
        ...
        <div class="content-editor-modal-inner">
            ...
            <label>
                ...
                <select id="announcementEditorAudience">
    ...
    try {
        ...
        if (
            ...
            alert(
                ...
                "データベースの権限設定（RLS）で\n" +
                "更新が許可されていない可能性があります。\n\n" +
                "Supabaseで sql/04_announcements_and_comments.sql を\n" +
                "実行してください。"
            );
